...
class TestSignupView(TestCase):
    ...
    def test_failure_post_with_empty_password(self):
        invalid_data = {"username": "username", "email": "test@test.com", "password1": "", "password2": ""}
        response = self.client.post(self.url, invalid_data)
        form = response.context["form"]
    ...
    def test_failure_post_with_duplicated_user(self):
        duplicated_data = {"username": "testuser", "email": "test@test.com", "password": "testpassword"}
    ...
    def test_failure_post_with_too_short_password(self):
        invalid_data = {"username": "username", "email": "test@test.com", "password1": "pass", "password2": "pass"}
